---
title: '<i class="fab fa-r-project"></i> - Packages Development'
pagetitle: 'R - Packages Development'
...
date: 'Monday, the 3<sup><i style="font-size:0.5em;">rd</i></sup> of February, 2020'
params:
